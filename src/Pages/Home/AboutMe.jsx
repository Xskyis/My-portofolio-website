      ...
      >
        <div className='hero--section--content'>
          ...
          <p className='hero--section--description'>
            I'm a student at Telkom Malang vocational high school, I like to
            explore new things, especially in the world of IT, currently
            learning JavaScript, React.js, Node.js, HTML, CSS.
          </p>
          <p className='hero--section--description'>
            Besides that I also have ability to design a UI from a website using
            figma, balanced with my ability to communicate well, work with a
            team, and adapt easily.
          </p>
            ...
            <div className='education--content'>
              <div className='education--content--box'>
                <div className='education--content--box--title'>
                  ...
                  <br />
                  <h4>
                    Studying Software Engineering and learning how to build
                    software and web applications using various technologies and
                    programming languages.
                  </h4>
                  <ul className='hero--section--description'>
                    <li>
                      Learned fundamentals of programming such as Data
                      Structures, Algorithms, Object Oriented Programming,
                      Functional Programming, and Software Engineering.
                    </li>
                    <li>
                      Learned about web development using HTML, CSS, JavaScript,
